...
**Awesome Books** is a book list application which stores our favourite books. User and add and remove books to the list and all the data will be stores in their local device in localStorage.
...
- [Live Demo Link](https://muhammadusmanaslam.github.io/awesome-books/)
